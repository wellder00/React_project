  ...
  const stories = [
    {
      ...
      date: '20 січня 2023',
      longDesc: `Знаєте, іноді наші волонтери стають справжніми чарівниками. \n Ці дівчата з 
      ...
      і вирішили їх порадувати. \n Зупинили авто, зайшли слідом за дітьми до магазину і
    ...
    {
      id: 228,
      title: 'Видача корму для людей, що прихистили безпритульних тварин',
  ...
  return (
    <div className="successful-stories">
      <div className="successful-stories-wrapper _container">
        ...
        <div className="successful-stories-desc">Хочемо поділитися історіями, в яких допомога знайшла своїх адресатів. Прагнемо, щоб таких історій було якомога більше.</div>
