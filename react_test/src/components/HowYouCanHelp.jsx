      ...
      <div className="can-help_wrapper _container">
        <div className="title-block">
          ...
          <div>
            ...
            зробить нашу роботу кращою та ефективнішою.
          </div>
        </div>
        <div className="can-help__first-block">
          <div className="donat-block">
            ...
            <div className="donat-block__description">
              ...
              Обстріли над головою, руйнування житла, втрата роботи, зачинені магазини та аптеки.<br/>
              Зруйновані плани на майбутнє та маленькі діти на руках. <br/> Старі люди, які не можуть
            ...
            <form>
              ...
              >
                *Введіть суму або виберіть із запропонованих вище
              </div>
            </form>
